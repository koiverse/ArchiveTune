...
import moe.koiverse.archivetune.innertube.utils.configurePlatformEngine
import moe.koiverse.archivetune.innertube.utils.currentTimeSeconds
import moe.koiverse.archivetune.innertube.utils.defaultCountry
import moe.koiverse.archivetune.innertube.utils.defaultLanguageTag
import moe.koiverse.archivetune.innertube.utils.parseCookieString
import moe.koiverse.archivetune.innertube.utils.platformEngine
...
class InnerTube {
    ...
    private fun createClient() = HttpClient(platformEngine()) {
        expectSuccess = true
